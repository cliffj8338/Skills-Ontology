# PROJECT_CONTEXT.md — Blueprint v4.20.0 (Nav Restructure + Icon System)
**Updated:** 2026-02-20 | **Lines:** 21,460 | **Functions:** ~425 | **Size:** ~1,144 KB | **Braces:** 0 (balanced)
...
4. **~90 emoji instances remain in deeper UI** — Modals, wizard steps, toast messages, skill detail panels, and various inline labels still use native emoji. These are lower-visibility surfaces. A systematic cleanup pass is queued as a priority item.
...
- **Remaining emoji cleanup** — ~90 emoji instances remain in deeper UI (modals, wizard, toast messages, skill detail). Systematic pass to convert all to bpIcon()
